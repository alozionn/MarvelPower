<!-- Used for loading the card for dimensions while waiting for fetcha -->
<div
  role="status"
  class="p-2 rounded border border-gray-200 shadow animate-pulse md:p-4 dark:border-gray-700"
>
  ...
  <div class="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5" />
  <!-- <div class="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5" />
